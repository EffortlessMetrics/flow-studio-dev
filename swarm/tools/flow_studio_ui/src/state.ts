 ...
 */
export const FLOW_STATUS_META: Record<FlowHealthStatus, FlowStatusMeta> = {
  ok: {
 ...
 */
export function setCurrentFlow(flowKey: FlowKey | null): void {
 ...
 */
export function setCompareRun(runId: string | null): void {
 ...
 */
export function setGovernanceOverlay(enabled: boolean): void {
 ...
 */
export function setSelectedNode(nodeId: string | null, nodeType: NodeType | null): void {
